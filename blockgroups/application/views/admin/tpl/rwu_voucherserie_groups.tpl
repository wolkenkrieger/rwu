	...
	<colgroup span="3" width="33%">
		<tr>
			<form name="myedit" id="myedit" action="[{ $oViewConf->getSelfLink() }]" method="post">
				...
				<input [{ $readonly }] type="button" value="[{ oxmultilang ident="RWU_BLOCKGROUPS_BLOCKGROUPS" }]" class="edittext" onclick="JavaScript:showDialog('&cl=voucherserie_groups&aoc=2&oxid=[{ $oxid }]');">
					[{ /if}]
				</td>
			</form>
