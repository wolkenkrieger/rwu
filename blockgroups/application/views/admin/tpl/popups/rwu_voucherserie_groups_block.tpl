...
<script type="text/javascript">
	...
	[{ /foreach }] ],
	'[{ $oViewConf->getAjaxLink() }]cmpid=container1&container=rwu_blockgroups_voucherserie_groups&synchoxid=[{ $oxid }]'
	);
	...
	[{assign var="sSep" value=","}]
	[{ /foreach }] ],
	'[{ $oViewConf->getAjaxLink() }]cmpid=container2&container=rwu_blockgroups_voucherserie_groups&oxid=[{ $oxid }]'
	);
...
<table width="100%">
	...
	<tr class="edittext">
		...
		<td align="center"><b>[{ oxmultilang ident="RWU_BLOCKGROUPS_BLOCKEDGROUPS" }]</b></td>
	</tr>
	<tr>
