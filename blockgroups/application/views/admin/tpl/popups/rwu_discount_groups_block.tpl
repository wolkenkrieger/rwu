...
<script type="text/javascript">
	...
	[{ /foreach }] ],
	'[{ $oViewConf->getAjaxLink() }]cmpid=container1&container=rwu_blockgroups_discount_groups&synchoxid=[{ $oxid }]'
	);
	...
	[{assign var="sSep" value=","}]
	[{ /foreach }] ],
	'[{ $oViewConf->getAjaxLink() }]cmpid=container2&container=rwu_blockgroups_discount_groups&oxid=[{ $oxid }]'
	);
